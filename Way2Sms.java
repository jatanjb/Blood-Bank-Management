package com.abhirathore2006.sms;
...
public class Way2Sms {
   ...
   public Way2Sms()
    ...
    public int main1(String no,String msag)
    {  
        final String USERNAME="9880019690";//REQUIRED
        final String PASSWORD="mangalore";//REQUIRED
     ...
     /*   if(args.length>0)
        ...
        { */
        	String msg2=" hey this is a test message"; //msg to be sent
            phoneNumber.append("9880019690"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
            phoneNumber.append(';');
 ...
 */        //baseurl 1:http://site4.way2sms.com/ 2:http://site4.way2sms.com/ 3.http://site1.way2sms.com/
        ...
        String textMessage=msag.toString();
        String strPhoneNumber=no.toString();
       
       
         
         sms.sendSMS(strPhoneNumber, textMessage, ACTION,USERNAME,PASSWORD);
