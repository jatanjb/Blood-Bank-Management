...
<body bgcolor="#e6c6d5"><center>
<p style="background-color: #ca0000; color: white;"><%
											String b=request.getParameter("err");
											if(b!=null){
											out.println(b);
											}%></p></center>

<form action="donorforgotpasswordjsp.jsp"><table border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
