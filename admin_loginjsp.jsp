...
PreparedStatement Stmt=Conn.prepareStatement("SELECT UID FROM DB2ADMINADMIN WHERE UID='"+name1+"' AND PASSWORD='"+password+"'");
...
out.println("Please check your name and id...");

%>
<%-- <jsp:forward	page="admin_login.jsp"><jsp:param name="err" value="Incorrect Username or password" /></jsp:forward> --%>
